...
print(f"🔥 {symbol} üzrə Discord Canlı Hesabat Botu İşə Düşdü!")
...
send_discord_message("🚀 **Pro Bot işə düşdü!** Hər dövrün hesabatı artıq birbaşa burada paylaşılacaq.")
...
try:
    while True:
        ...
        # Terminalda görünən mətnin eynisini hazırlayırıq
        report_message = (
        ...
        # Həm terminala yaz, həm də Discord-a göndər
