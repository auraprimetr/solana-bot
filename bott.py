...
# Bybit birjasını aktivləşdiririk (Heç bir IP məhdudiyyəti yoxdur)
exchange = ccxt.bybit({
...
        symbol = 'SOL/USDT'
        
        # 1. Klines (OHLCV) məlumatını çəkirik (RSI və MACD üçün)
...
    while True:
        check_market()
        time.sleep(300) # Hər 5 dəqiqədən bir yoxlayır
